...
bool CheckBlockSignature(const CBlock& block)
{
    ...
    /** Each block is signed by the private key of the input that is staked. This can be either zXXX or normal UTXO
     *  zPIV: Each zXXX has a keypair associated with it. The serial number is a hash of the public key.
