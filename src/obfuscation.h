...
{
public:
    /// Is the inputs associated with this public key? (and there is 1000 XXX - checking if valid masternode)
...
private:
    ...
    unsigned int state; // should be one of the POOL_STATUS_Adultchain values
