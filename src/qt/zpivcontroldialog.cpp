    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to precompute or spend zXXX.";
            else if (!mint.isSeedCorrect)
                strReason = "The zXXX seed used to mint this zXXX is not the same as currently hold in the wallet";
            else
