...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 6900;
        bnProofOfWorkLimit = uint256("0x0000ffff00000000000000000000000000000000000000000000000000000000");
         ...
         */
        const char* pszTimestamp = "adultchain 10032020";
